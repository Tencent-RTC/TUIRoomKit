  ...
  <div :class="['chat-editor', cannotSendMessage ? 'disable-editor' : '']">
    <div class="chat-input-container">
      <div class="input-content">
        <svg-icon class="emoji-icon" icon-name="emoji-h5" size="medium" @click="togglePopover" />
        <input
          ref="editorInputEle"
          v-model="sendMsg"
          type="text"
      ...
      <span class="send" @click="sendMessage">{{ t('Send') }}</span>
    </div>
...
import emoji from '../EditorTools/emojiContentWX.vue';
