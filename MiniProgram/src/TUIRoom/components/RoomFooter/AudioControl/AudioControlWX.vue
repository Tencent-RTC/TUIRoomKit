    ...
    >
      ...
      <template #footer>
        <div class="dialog-footer">
          <span class="popup-button-turnon" @click="handleAccept">{{ t('Turn on the microphone') }}</span>
          <span class="popup-button-close" @click="handleReject">{{ t('Keep it closed') }}</span>
        </div>
      </template>
    </Dialog>
  </div>
...
import Dialog from '../../../elementComp/Dialog/DialogWX.vue';
