  ...
  <div class="control-container">
    ...
    <div v-if="showRoomDetail || hasGivenRoomId " class="room-detail">
      <div class="room-detail-header">
        <svg-icon class="close-icon" icon-name="close-back" size="custom" @click="handleClose"></svg-icon>
      ...
      <div class="room-detail-bottom">
        <span v-if="isJoinRoom || hasGivenRoomId" class="button" @click="handleRoomOption('Join')">{{ t('Join Room') }}</span>
        <span v-else class="button" @click="handleRoomOption('New')">{{ t('New Room') }}</span>
      </div>
    </div>
