<template>
  ...
  >
    ...
    <div
      ...
      :class="['center-user-info-container', showVoiceBorder ? 'border' : '']"
    >
...
const showVoiceBorder = computed(() => props.stream?.audioVolume !== 0 && props.stream?.streamType !== TUIVideoStreamType.kScreenStream);
// const showEnlargeIcon = computed(() => props.currentChooseStream === props.stream);
