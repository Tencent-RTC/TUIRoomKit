...
import RoomHeader from './components/RoomHeader/roomHeaderWX/index.vue';
import RoomContent from './components/RoomContent/index.vue';
import RoomFooter from './components/RoomFooter/index/indexWX.vue';
import RoomSidebar from './components/RoomSidebar/indexWX.vue';
