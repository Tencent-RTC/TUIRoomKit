    ...
    >
      <div id="test-preview" class="test-preview">
        <div class="reset" @click="handleShowResetDialog">
          <svg-icon style="display: flex" :icon="ResetIcon" />
        ...
        >
          <svg-icon style="display: flex" :icon="CompareIcon" />
...
import BasicBeautyIcon from '../../assets/icons/BasicBeautyIcon.svg';
import { useI18n } from '../../locales';
import { roomService, MetricsKey } from '../../services';
import Dialog from '../common/base/Dialog/index.vue';
import TuiButton from '../common/base/Button.vue';
import Slider from '../common/base/Slider.vue';
import CloseBeautyIcon from '../../assets/icons/CloseBeautyIcon.svg';
import SmootherBeautyIcon from '../../assets/icons/SmootherBeautyIcon.svg';
import WhiteningBeautyIcon from '../../assets/icons/WhiteningBeautyIcon.svg';
import RuddyBeautyIcon from '../../assets/icons/RuddyBeautyIcon.svg';
