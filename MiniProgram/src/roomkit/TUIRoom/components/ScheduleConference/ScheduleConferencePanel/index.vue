...
import TuiDatepicker from '../../common/base/Datepicker/index.vue';
import TuiTimepicker from '../../common/base/Timepicker/index.vue';
...
import ScheduleAttendees from '../../../assets/icons/ScheduleAttendees.svg';
