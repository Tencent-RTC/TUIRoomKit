...
public class TUIRoomSetBaseViewController: UIViewController, TUIRoomPresentBottomVCProtocol {
...
public class TUIRoomPresentBottom: UIPresentationController {
    ...
    override public init(presentedViewController: UIViewController, presenting presentingViewController: UIViewController?) {
        ...
        if case let vc as TUIRoomSetBaseViewController = presentedViewController {
...
extension UIViewController: UIViewControllerTransitioningDelegate {
    ...
    public func presentBottom(_ vc: TUIRoomSetBaseViewController) {
