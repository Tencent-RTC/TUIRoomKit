...
public class TUIRoomEntranceViewController: UIViewController {
    ...
    lazy var helpButton: UIButton = {
        let button = UIButton(type: .custom)
        button.setImage(UIImage(named: "tuiroom_help_icon"), for: .normal)
        button.sizeToFit()
        return button
    }()
    ...
    lazy var createButton: UIButton = {
        ...
        let imageLeftView = UIImageView(image: UIImage(named: "tuiroom_create_room_icon"))
        ...
        let imageRightView = UIImageView(image: UIImage(named: "tuiroom_guide_icon"))
        ...
        button.setBackgroundImage(UIImage(named: "tuiroom_entrance_btn_bg_icon"), for: .normal)
    ...
    lazy var quickJoinButton: UIButton = {
        ...
        let btnWidth: CGFloat = 289
        button.titleEdgeInsets = UIEdgeInsets(top: 0, left: 58, bottom: 0, right: btnWidth - button.frame.size.width)
        let imageLeftView = UIImageView(image: UIImage(named: "tuiroom_join_room_icon"))
        button.addSubview(imageLeftView)
        imageLeftView.snp.makeConstraints { make in
            make.width.height.equalTo(32)
            make.left.equalToSuperview().offset(19)
...
private extension String {
    static let titleText = TRTCDemoLocalize("TUIRoom.create.title")
    static let createText = TRTCDemoLocalize("TUIRoom.create.room")
    static let quickJoinText = TRTCDemoLocalize("TUIRoom.quick.join")
    static let noLoginToast = TRTCDemoLocalize("TUIRoom.not.login.toast")
}
