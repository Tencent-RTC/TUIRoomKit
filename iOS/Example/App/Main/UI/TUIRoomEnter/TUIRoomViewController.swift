...
class TUIRoomViewController: UIViewController {
    ...
    lazy var backButton: UIButton = {
        ...
        button.setImage(UIImage(named: "liveroom_back"), for: .normal)
        return button
    }()
    ...
    lazy var userNameLabel: UILabel = {
        ...
        view.text = TUILogin.getNickName()
        view.adjustsFontSizeToFitWidth = true
        view.minimumScaleFactor = 0.5
        view.sizeToFit()
        return view
    ...
    lazy var copyButton: UIButton = {
        let button = UIButton(type: .custom)
        button.setImage(UIImage(named: "tuiroom_copy_icon"), for: .normal)
        return button
    }()
    ...
    func enterMainViewController(_ roomId: String, isCreate: Bool) {
        let roomInfo = RoomInfo()
        roomInfo.roomId = roomId
        roomInfo.isOpenCamera = openCameraSwitch.isOn
        roomInfo.isOpenMicrophone = openMicSwitch.isOn
...
extension TUIRoomViewController: TUIRoomKitListener {
    func onEnterRoom(code: TUIError, message: String) {
...
private extension String {
    ...
    static let userNameText = TRTCDemoLocalize("TUIRoom.user.name")
    static let roomNumText = TRTCDemoLocalize("TUIRoom.room.num")
    static let placeholderTipsText = TRTCDemoLocalize("TUIRoom.input.room.num")
    static let openCameraText = TRTCDemoLocalize("TUIRoom.open.camera")
    static let openMicText = TRTCDemoLocalize("TUIRoom.open.mic")
    static let copySuccessText = TRTCDemoLocalize("TUIRoom.copy.success")
}
