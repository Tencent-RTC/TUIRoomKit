...
class SelectedMembersViewController: UIViewController {
    ...
    var didDeselectMember: ((User) -> Void)?
    private let arrowViewHeight: CGFloat = 35.0
    
    init(showDeleteButton: Bool = true, selectedMembers: [User] = []) {
    ...
    private let dropArrowImageView: UIImageView = {
        ...
        view.image = UIImage(named: "room_drop_arrow")
        return view
    }()
...
class SelectedMemberCell: UITableViewCell {
    ...
    private let nameLabel: UILabel = {
     ...
     let deleteButton: UIButton = {
        ...
        let image = UIImage(named: "room_delete")
    ...
    func updateView(with info: User) {
