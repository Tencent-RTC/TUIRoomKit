...
# spec.requires_arc = true
 ...
 spec.subspec 'TRTC' do |trtc|
   ...
   trtc.source_files = 'Source/Localized/**/*.{h,m,mm,swift}', 'Source/model/**/*.{h,m,mm,swift}', 'Source/ui/**/*.{h,m,mm,swift}', 'Source/TUIMeetingKit_TRTC/*.{h,m,mm,swift}'
   trtc.ios.framework = ['AVFoundation', 'Accelerate']
   trtc.library = 'c++', 'resolv'
   trtc.resource_bundles = {
   'TUIMeetingKitBundle' => ['Resources/*.xcassets', 'Resources/Localized/**/*.strings', 'Resources/*.json', 'Resources/*.mp4', 'Resources/*.bundle' ]
 }
 end
 ...
 spec.subspec 'Enterprise' do |enterprise|
   ...
   enterprise.source_files = 'Source/Localized/**/*.{h,m,mm,swift}', 'Source/model/**/*.{h,m,mm,swift}', 'Source/ui/**/*.{h,m,mm,swift}', 'Source/TUIMeetingKit_Enterprise/*.{h,m,mm,swift}'
