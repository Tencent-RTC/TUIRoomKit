/// @defgroup V2TXLivePusherObserver_cplusplus V2TXLivePusherObserver
/// 腾讯云直播推流的回调通知。<br/>
...
class V2TXLivePusherObserver {
   public:
     ...
     * 自定义视频预处理数据回调
     *
     * @note  调用 {@link V2TXLivePusher#enableCustomVideoProcessing} 接口开启/关闭自定义视频处理回调
...
#endif  // MODULE_CPP_V2TXLIVEPUSHEROBSERVER_H_
/// @}
