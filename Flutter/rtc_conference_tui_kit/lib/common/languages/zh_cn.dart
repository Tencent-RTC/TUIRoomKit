const Map<String, String> roomContentsZhCN = {
  ...
  'highDefinition': '高清',
  'superDefinition': '超清',
  'allMutePrompt': '已将全体成员静音',
  'allUnMutePrompt': '已关闭全员静音',
  'disableAllVideoPrompt': '已将全体成员禁画',
  'enableAllVideoPrompt': '已关闭全员禁画',
  ...
  'joinStage': '上台',
  'cancelStage': '取消上台',
  'takeSeatRequestAgreed': '房主/管理员同意了您的上台申请',
  'takeSeatRequestRejected': '房主/管理员拒绝了您的上台申请',
  ...
  'haveRevokedAdministrator': '已撤销了xx的管理员身份',
  'haveBecomeAdministrator': '您已被设为管理员',
