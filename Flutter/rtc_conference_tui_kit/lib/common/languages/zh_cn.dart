const Map<String, String> roomContentsZhCN = {
  ...
  'highDefinition': '高清',
  'superDefinition': '超清',
  'allMutePrompt': '主持人已将全体成员静音',
  'allUnMutePrompt': '主持人已关闭全员静音',
  'disableAllVideoPrompt': '主持人已将全体成员禁画',
  'enableAllVideoPrompt': '主持人已关闭全员禁画',
  ...
  'raiseHand': '举手',
  'handDown': '手放下',
  'takeSeatRequestAgreed': '主持人同意了您的上台申请',
  'takeSeatRequestRejected': '主持人拒绝了您的上台申请',
  'handDownToast': '您已将手放下',
  'raiseHandTip': '举手发言房间，请先举手申请上麦',
  'inviteToTakeSeat': '邀请上台',
  'inviteMemberToTakeSeat': '邀请成员上台',
  'kickOffSeat': '请下台',
  'raiseHandApplication': '举手申请',
  'agreeAll': '全部同意',
  'disagreeSeat': '拒绝上台',
