const Map<String, String> roomContentsEnUS = {
  ...
  'allMutePrompt': 'The host has banned all members from turning on the audio',
  'allUnMutePrompt': 'The host has turned off the mute for all participants',
  'disableAllVideoPrompt':
      'The host has banned all members from turning on the camera',
  'enableAllVideoPrompt':
      'The host has turned off the camera disable for all participants',
  ...
  'takeSeatRequestAgreed':
      'The moderator has approved your request to take seat',
  'takeSeatRequestRejected':
      'The moderator has rejected your request to take seat',
  'handDownToast': 'You have put your hands down',
  'raiseHandTip':
  ...
  'raiseHandApplication': 'Raise hand applications',
