...
public class IMService {
    ...
    public void createRoom(final String roomId, final TUIRoomCoreDef.SpeechMode speechMode, final String roomName,
        ...
        imManager.createGroup(V2TIMManager.GROUP_TYPE_PUBLIC, roomId, roomName, new V2TIMValueCallback<String>() {
            @Override
                ...
                if (code == 10025) {
                    ...
                    getRoomNotification(roomId, new TUIRoomCoreCallback.ActionCallback() {
                        ...
                        public void onCallback(int code, String msg) {
                            if (code == 0) {
                                onCreateSuccess(roomId, speechMode, roomName, true, callback);
                            } else {
                                if (callback != null) {
            ...
            public void onSuccess(String s) {
                onCreateSuccess(roomId, speechMode, roomName, false, callback);
            }
        });
    }
                            ...
                            public void onSuccess(List<V2TIMGroupInfoResult> v2TIMGroupInfoResults) {
                                ...
                                if (v2TIMGroupInfoResults != null && v2TIMGroupInfoResults.size() == 1) {
                                    ...
                                    if (v2TIMGroupInfoResult != null) {
                                        ...
                                        getGroupMemberList(roomId, new TXUserInfoListCallback() {
                                            @Override
    ...
    private void getGroupMemberList(String roomId, final TXUserInfoListCallback callback) {
