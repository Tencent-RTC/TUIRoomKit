    ...
    public static void requestPermission(Context context, @PermissionType int type, final PermissionCallback callback) {
        ...
        switch (type) {
            case PERMISSION_MICROPHONE: {
                ...
                reasonTitle = resources.getString(R.string.tuiroom_permission_mic_reason_title, appName);
                reason = resources.getString(R.string.tuiroom_permission_mic_reason);
                deniedAlert = resources.getString(R.string.tuiroom_tips_start_audio);
                break;
            }
            case PERMISSION_CAMERA: {
                permission = PermissionRequester.PermissionConstants.CAMERA;
                reasonTitle = resources.getString(R.string.tuiroom_permission_camera_reason_title, appName);
                reason = resources.getString(R.string.tuiroom_permission_camera_reason);
                deniedAlert = resources.getString(R.string.tuiroom_tips_start_camera);
                break;
            }
            default:
                break;
