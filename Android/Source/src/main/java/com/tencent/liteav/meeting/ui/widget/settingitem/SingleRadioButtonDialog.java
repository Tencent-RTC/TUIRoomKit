...
public class SingleRadioButtonDialog extends BottomSheetDialog {
    ...
    public SingleRadioButtonDialog(Context context, List<String> dataArray) {
        super(context, R.style.TRTCMeetingBaseFragmentDialogTheme);
        mContext = context;
        mDataArray = dataArray;
        setContentView(R.layout.trtcmeeting_dialog_single_radio_button);
        initView();
    }
    ...
    private RadioButton createRadioButton(String text) {
        ...
        radioButton.setTextColor(mContext.getResources().getColor(R.color.trtcmeeting_color_second_text));
    ...
    private void setStyle(RadioButton rb) {
        ...
        Drawable drawable = mContext.getResources().getDrawable(R.drawable.trtcmeeting_bg_meeting_rb_icon_selector);
        //定义底部标签图片大小和位置
