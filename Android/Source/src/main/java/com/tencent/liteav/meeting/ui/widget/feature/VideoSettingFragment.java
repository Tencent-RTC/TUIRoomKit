...
public class VideoSettingFragment extends BaseSettingFragment {
    ...
    protected void initView(View itemView) {
         ...
         */
        BaseSettingItem.ItemText itemText = new BaseSettingItem.ItemText(getString(R.string.trtcmeeting_title_bitrate), "");
        ...
        itemText = new BaseSettingItem.ItemText(getString(R.string.trtcmeeting_title_resolution), getResources().getStringArray(R.array.solution));
        ...
        mTRTCMeeting.setVideoResolution(getResolution(mCurRes));
        mSettingItemList.add(mResolutionItem);

        //帧率
        itemText = new BaseSettingItem.ItemText(getString(R.string.trtcmeeting_title_frame_rate), getResources().getStringArray(R.array.video_fps));
        ...
        mTRTCMeeting.setVideoFps(getFps(mVideoFpsItem.getSelected()));
        ...
        mTRTCMeeting.setVideoBitrate(getBitrate(mFeatureConfig.getVideoBitrate(), mCurRes));
        mSettingItemList.add(mBitrateItem);

        itemText =
                new BaseSettingItem.ItemText(getString(R.string.trtcmeeting_title_local_mirror),
                        getString(R.string.trtcmeeting_title_enable), getString(R.string.trtcmeeting_title_disable));
