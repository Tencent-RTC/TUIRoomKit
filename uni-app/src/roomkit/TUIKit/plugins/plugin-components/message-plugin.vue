<template>
  <MessagePluginLayout
    ...
    :show-style="pluginMessageType.showStyle"
    :bubble-class-name-list="[pluginMessageType.pluginType === 'room' ? 'message-bubble-room':'']"
...
import TUIChatEngine, { TUIStore, IMessageModel } from '@tencentcloud/chat-uikit-engine';
// import {
