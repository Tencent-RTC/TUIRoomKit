  ...
  >
    ...
    <div class="corner-user-info-container">
      ...
      <audio-icon
        ...
        size="small"
      ></audio-icon>
      <svg-icon v-if="isScreenStream" style="display: flex" :icon="ScreenOpenIcon" class="screen-icon"></svg-icon>
...
import ScreenOpenIcon from '../../../assets/icons/ScreenOpenIcon.png';
...
import {
  ...
  TRTCVideoMirrorType,
  TRTCVideoRotation,
  TUIRole } from '@tencentcloud/tuiroom-engine-uniapp-app';
