...
export class RoomService {
  ...
  public initMediaDeviceList() {
    const { initMediaDeviceList } = useDeviceManager({ listenForDeviceChange: true });
    initMediaDeviceList();
  }
  ...
  public async enterRoom(options: { roomId: string; roomParam?: RoomParam }) {
    ...
    try {
      ...
      if (this.roomStore.isMaster && this.roomStore.isSpeakAfterTakingSeatMode) {
