...
- 依赖 [@tencentcloud/roomkit-web-vue3](https://www.npmjs.com/package/@tencentcloud/roomkit-web-vue3) v2.2.3 版本，@tencentcloud/roomkit-web-vue3 接入信息请查看 [roomkit 快速接入](https://cloud.tencent.com/document/product/647/81962);

## 2024.04.08@2.2.2

**Feature**

- 升级 [@tencentcloud/tuiroom-engine-js](https://www.npmjs.com/package/@tencentcloud/tuiroom-engine-js) 到 v2.2.2 版本，详情请查看 [发布日志](https://cloud.tencent.com/document/product/1690/89361)；

**Improvement**
- 优化 onKickedOffLine 回调时清理资源并执行 TRTC 退房操作;
- 更新 trtc-cloud-js-sdk, 提供截图能力;
...
- 升级 [@tencentcloud/tuiroom-engine-js](https://www.npmjs.com/package/@tencentcloud/tuiroom-engine-js) 到 v2.2.0 版本，详情请查看 [发布日志](https://cloud.tencent.com/document/product/1690/89361)；
...
- 升级 [@tencentcloud/tuiroom-engine-js](https://www.npmjs.com/package/@tencentcloud/tuiroom-engine-js) 到 v2.1.0 版本，详情请查看 [发布日志](https://cloud.tencent.com/document/product/1690/89361)；
...
- 升级 [@tencentcloud/tuiroom-engine-js](https://www.npmjs.com/package/@tencentcloud/tuiroom-engine-js) 到 v2.0.3 版本，详情请查看 [发布日志](https://cloud.tencent.com/document/product/1690/89361)；
...
- Web 移动端不再展示 scheme 邀请链接；

## 2024.01.29@2.0.2

**Feature**

- 升级 [@tencentcloud/tuiroom-engine-js](https://www.npmjs.com/package/@tencentcloud/tuiroom-engine-js) 到 v2.0.2 版本，详情请查看 [发布日志](https://cloud.tencent.com/document/product/1690/89361)；
- 转交房主新增 Dialog 确认框。

**Bug Fixed**
- 修复移动端 H5 IOS 设备中部分 icon 展示模糊的问题。
