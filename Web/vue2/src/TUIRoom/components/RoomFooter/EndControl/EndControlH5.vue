<template>
  <div>
    <div class="end-control-container">
      <div class="end-button" tabindex="1" @click="stopMeeting">{{ t('EndH5') }}</div>
    </div>
...
.end-control-container{
  ...
  .manage-transfer{
    ...
    .end-dialog-header {
      background: var(--end-control-title-h5);
      ...
      .end-button-cancel {
        ...
        bottom: -9vh;
        left: 0;
        background-color: var(--end-control-cancel-h5);
        border-radius: 14px;
        color: #007AFF;
        font-weight: 600;
      }
