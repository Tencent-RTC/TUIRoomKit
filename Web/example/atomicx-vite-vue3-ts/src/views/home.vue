    ...
    <main class="main">
      ...
      <div class="main-container">
        <div class="room-preview-container">
          <div class="camera-preview-area">
            ...
            <div class="attention-info">
              <span v-if="!isCameraTesting && !isCameraTestLoading" class="off-camera-info">{{ t('Off Camera') }}</span>
              <IconLoading
          ...
          <div class="control-container">
            ...
            <div class="room-control-region">
              <StartRoomButton class="button-item" @start-room="handleStartRoom" />
        ...
        <div class="schedule-list">
          <ScheduledRoomList @join-room="(roomInfo: { roomId: string }) => handleJoinRoom(roomInfo.roomId)" />
        </div>
      </div>
    </main>
  </div>
...
import { useUIKit, IconLoading, TUIMessageBox, TUIToast } from '@tencentcloud/uikit-base-component-vue3';
import { ScheduledRoomList, useDeviceState, useRoomState, useRoomModal } from 'tuikit-atomicx-vue3/room';
import { useRouter } from 'vue-router';
import { MicButton, CameraButton, JoinRoomButton, LanguageButton, LoginUserInfo, ScheduledRoomButton, StartRoomButton, ThemeButton } from '../components';
