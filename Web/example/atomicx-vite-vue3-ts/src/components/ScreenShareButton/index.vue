...
const canShareScreen = computed(() => !currentRoom.value?.isAllScreenShareDisabled || (localParticipant.value?.role === RoomParticipantRole.Owner || localParticipant.value?.role === RoomParticipantRole.Admin));
