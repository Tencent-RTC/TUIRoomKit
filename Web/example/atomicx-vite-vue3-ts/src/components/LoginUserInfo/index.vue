  ...
  <div class="login-user-info">
    ...
    >
      <div class="login-user-info-trigger">
        ...
        <span class="user-id">{{ loginUserInfo?.userName || loginUserInfo?.userId }}</span>
...
import { IconCaretDownSmall, TUIDropdown, TUIDropdownItem, TUIToast, useUIKit } from '@tencentcloud/uikit-base-component-vue3';
