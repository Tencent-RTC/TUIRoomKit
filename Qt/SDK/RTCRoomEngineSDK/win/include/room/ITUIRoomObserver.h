...
class TUIRoomObserver {
   public:
     ...
     */
    virtual void onRoomDismissed(const char* roomId, TUIRoomDismissedReason reason) = 0;
     ...
     */
    virtual void onRoomUserCountChanged(const char* roomId, int userCount) = 0;
     ...
     * @param userInfo 用户信息。
     */
    virtual void onUserRoleChanged(const TUIUserInfo& userInfo) = 0;
     ...
     * 4.8 用户网络状态变化事件
     *
     * @param networkList 用户网络状态数组，可参见 {@link TUINetwork} 对象。
     */
     ...
     */
    virtual void onKickedOffSeat(int seatIndex, const TUIUserInfo& operateUser) = 0;
     ...
     */
    virtual void onRequestCancelled(const TUIRequest& request, const TUIUserInfo& operateUser) = 0;
     ...
     * @param operateUser 取消信令的用户信息。
     */
    virtual void onRequestProcessed(const TUIRequest& request, const TUIUserInfo& operateUser) = 0;
     ...
     * @param roomId 房间ID。
     */
    room_engine_attribute_deprecated virtual void onRoomDismissed(const char* roomId) = 0;
     ...
     */
    room_engine_attribute_deprecated virtual void onUserRoleChanged(const char* userId, TUIRole role) = 0;
     ...
     */
    room_engine_attribute_deprecated virtual void onKickedOffSeat(const char* userId) = 0;
     ...
     */
    room_engine_attribute_deprecated virtual void onRequestCancelled(const char* requestId, const char* userId) = 0;
     ...
     */
    room_engine_attribute_deprecated virtual void onRequestProcessed(const char* requestId, const char* userId) = 0;
};
