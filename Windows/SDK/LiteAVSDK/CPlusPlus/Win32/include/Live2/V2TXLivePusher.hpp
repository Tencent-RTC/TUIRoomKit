/// @defgroup V2TXLivePusher_cplusplus V2TXLivePusher
/// 腾讯云直播推流器。<br/>
 ...
 */
#ifdef _WIN32
    virtual IV2TXLiveScreenCaptureSourceList* getScreenCaptureSources(const SIZE& thumbSize, const SIZE& iconSize) = 0;
#endif
...
#endif  // MODULE_CPP_V2TXLIVEPUSHER_H_
/// @}
