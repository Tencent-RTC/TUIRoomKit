...
│   ├── TUIRoom  // TUIRoomKit UI component source files
│   ├── config   // TUIRoomKit Configuration File
...
2. Find and open ` Electron/vue2/src/config/basic-info-config.js` file。
...
3. Build the installer, run
   ...
   ```
   > Note: The built installer is located in the bin directory. By default, you can only build Mac installers using Mac computers, and Windows installers using Windows computers.
