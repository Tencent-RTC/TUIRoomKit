export default {
  ...
  'Join Room': '进入房间',
  'Enter a room ID': '输入房间号',
  'Smooth (360p, 15 fps)': '流畅（360P，15FPS）',
  'SD (540p, 15 fps)': '标清（540P，15FPS）',
  'HD (720p, 30 fps)': '高清（720P，30FPS）',
  'FHD (1080p, 30 fps)': '超清（1080P，30FPS）',
  'End sharing': '结束共享',
  ...
  'The host has allowed you to turn on the microphone': '主持人已允许您开启麦克风',
  ...
  'The host has allowed you to turn on the camera': '主持人已允许你开启摄像头',
